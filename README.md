...
Mohd Faizanul Haque Data Analyst | SQL • Python • Power BI • Snowflake • Tableau  I’m a data analytics professional passionate about turning raw data into actionable business insights. I build data pipelines, analyze complex datasets, and create interactive dashboards that help answer real-world business questions.
